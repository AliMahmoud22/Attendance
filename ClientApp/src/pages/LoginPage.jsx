...
export default function LoginPage() {
  ...
  return (
    <div className="grid lg:grid-cols-5 md:grid-cols-2  items-center bg-[#BDE8F5]/40 gap-y-4 min-h-screen">
      ...
      {/* Right Side Form */}
      <div className="lg:col-span-2 w-full bg-[#1C4D8D]/80 md:rounded-xl md:rounded-xl p-8 max-w-lg mx-auto">
        <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="rememberMe" className="ml-3 text-[15px] text-slate-900">
                Remember me
              </label>
            </div>
          </div>
