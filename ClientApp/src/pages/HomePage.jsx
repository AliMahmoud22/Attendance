...
export default function HomePage() {
  ...
  return (
    <>
      <h3 className="text-center text-3xl font-bold text-gray-700 dark:text-gray-100 mt-6 mb-6">
          ...
          <NavCard to="/emp-shifts" label="شيفتات الموظفين">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M17 20h5v-2a2 2 0 00-2-2h-3V8a2 2 0 00-2-2H9a2 2 0 00-2 2v8H4a2 2 0 00-2 2v2h5"
              />
            </svg>
          </NavCard>
          ...
          <NavCard to="/employees" label="بيانات الموظفين">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M5.121 17.804A8.966 8.966 0 0112 15c2.21 0 4.21.803 5.879 2.137M15 11a3 3 0 11-6 0 3 3 0 016 0z"
              />
            </svg>
          </NavCard>
